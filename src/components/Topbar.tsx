...
const Topbar = ({ text, showText }: Topbar) => {
  return (
    <div className="flex max-sm:flex-col items-center border-b-2 border-[#3BC8C0] p-3 w-full">
      ...
      <div className=" flex flex-col gap-4 mt-5  justify-center items-center w-full">
        <div className="h-10 text-center">
          {showText && (
            <span className="text-4xl font-bold  max-sm:text-xl ">
              Welcome to Offroad Lodge
            </span>
          )}
        </div>
